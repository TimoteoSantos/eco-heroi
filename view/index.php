...
<p><a href="Jogada.php"  class="btn btn-success largura3">Jogar</a></p>

<p><a href="historico.php" class="btn btn-warning historico largura">Histórico</a></p>


<?php if($_SESSION['tipouser'] == 'sim'){ ?>
...
<a href="gestorPalavras.php"> Gestão de palavras</a> |
...
</svg> <a href="../model/sair.php"> Sair</a>
